...
export function buildKpi(tot, hours = []) {
  ...
  return '<div class="savings-kpi">' +
    '<div class="kpi"><span class="kpi-label">' + t('chart.orig_tokens') + '</span><span class="kpi-val">' + fmtTokens(orig) + '</span></div>' +
    '<div class="kpi"><span class="kpi-label">' + t('chart.opt_payload') + '</span><span class="kpi-val kpi-opt">' + fmtTokens(opt) + '</span></div>' +
